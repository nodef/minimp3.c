...
Minimalistic, single-header library for decoding MP3, by [Lion](https://github.com/lieff). minimp3 is designed to be
...
And then include `minimp3.h` as follows:
...
Finally, compile while adding the path `node_modules/minimp3.c` to your compiler's include paths.

```bash
$ clang -I./node_modules/minimp3.c main.c  # or, use gcc
$ gcc   -I./node_modules/minimp3.c main.c
```
...
Just `#include "node_modules/minimp3.c/minimp3/minimp3_ex.h"` instead and use following additional functions:
...
[![SRC](https://img.shields.io/badge/src-repo-green?logo=Org)](https://github.com/lieff/minimp3)
[![ORG](https://img.shields.io/badge/org-nodef-green?logo=Org)](https://nodef.github.io)
![](https://ga-beacon.deno.dev/G-RC63DPBH3P:SH3Eq-NoQ9mwgYeHWxu7cw/github.com/nodef/minimp3.c)
